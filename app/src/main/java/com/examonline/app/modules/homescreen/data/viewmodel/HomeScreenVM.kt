...
import com.examonline.app.modules.homescreen.data.model.ScheduleItemModel
...
public class HomeScreenVM : ViewModel(), KoinComponent {
  ...
  public val scheduleList: MutableLiveData<MutableList<ScheduleItemModel>> =
...
//    val scheduleListValue = scheduleList.value
...
//      }
//      val c = ScheduleItemModel(r.ExamName,
...
//      )
//      scheduleListValue?.add(c)
//    }
//    scheduleList.value = scheduleListValue
  }
